  ...
  return (
    ...
    >
      ...
      <Input
        ref={inputRef}
        variant="link"
        className="h-auto w-full resize-none rounded-none bg-transparent p-0 leading-none font-bold break-words text-[#3F3F3F] outline-hidden md:text-[40px] dark:text-[#CFCFCF]"
        readOnly={readOnly}
        value={title ?? ''}
        onChange={(e) => {
          authGuard(() => {
